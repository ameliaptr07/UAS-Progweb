...
if (isset($_POST['submit'])) {
    ...
    if ($nama_hapus) {
        ...
        $sql = "DELETE FROM pameran WHERE nama = '$nama_hapus'";

        if (mysqli_query($conn, $sql)) {
            echo "Data pameran berhasil dihapus!";
        } else {
            echo "Gagal menghapus data pameran.";
        }
    } else {
        echo "Mohon masukkan Nama Pameran.";
    }
}
...
<head>
    <meta charset="UTF-8">
    <title>Hapus Data Pameran</title>
    <style>
        body {
