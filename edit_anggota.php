...
if (isset($_POST['submit'])) {
    ...
    $diklat_baru = $_POST['diklat'];

    if ($nama_baru && $nim_baru && $fakultas_baru && $prodi_baru && $diklat_baru) {
        $update_query = "UPDATE anggota_aktif SET  
                         nama = '$nama_baru', 
...
if (isset($_POST['cari_nim'])) {
    $nim = $_POST['nim'];
    $query = "SELECT * FROM anggota_aktif WHERE nim = '$nim'";
...
<head>
    <meta charset="UTF-8">
    <title>Perbarui Data Anggota</title>
    <style>
        body {
...
<body>
    <h2>Perbarui Data Anggota Aktif</h2>
    <form method="POST" action="">
        <table>
            ...
            <tr>
                <td>Diklat</td>
                <td><input type="text" name="diklat" value="<?php echo isset($data['diklat']) ? $data['diklat'] : ''; ?>" maxlength="50" /></td>
            </tr>
            <tr>
