...
if (isset($_POST['submit'])) {
    ...
    $katalog_baru = $_POST['katalog'];
    $keterangan_baru = $_POST['keterangan'];

    if ($tanggal_baru && $nama_baru && $tempat_baru && $katalog_baru && $keterangan_baru) {
        $update_query = "UPDATE pameran SET 
                         tanggal = '$tanggal_baru', 
                         tempat = '$tempat_baru', 
                         katalog = '$katalog_baru', 
                         keterangan = '$keterangan_baru' 
                         WHERE nama = '$nama_baru'";

        if (mysqli_query($conn, $update_query)) {
            echo "Data pameran berhasil diperbarui!";
        } else {
...
if (isset($_POST['cari_nama'])) {
    $nama = $_POST['nama'];
    $query = "SELECT * FROM pameran WHERE nama = '$nama'";
...
<head>
    <meta charset="UTF-8">
    <title>Perbarui Data Pameran</title>
    <style>
        body {
...
<body>
    <h2>Perbarui Data Pameran</h2>
    <form method="POST" action="">
        <table>
            <tr>
                <td>Nama Pameran</td>
                <td>
                    <input type="text" name="nama" value="<?php echo isset($data['nama']) ? $data['nama'] : ''; ?>" maxlength="100" placeholder="Masukkan Nama Pameran" />
            ...
            <tr>
                <td>Katalog</td>
                <td><input type="text" name="katalog" value="<?php echo isset($data['katalog']) ? $data['katalog'] : ''; ?>" maxlength="100" /></td>
            </tr>
            <tr>
                <td>Keterangan</td>
    ...
    <br><br>
    <a href="pameran.php" class="button">Kembali ke Daftar Pameran</a>
</body>
</html>
