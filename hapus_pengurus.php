...
if (isset($_POST['submit'])) {
    ...
    if ($nim_hapus) {
        $sql = "DELETE FROM pengurus WHERE nim = '$nim_hapus'";

        if (mysqli_query($conn, $sql)) {
            echo "Data pengurus berhasil dihapus!";
        } else {
            echo "Gagal menghapus data pengurus.";
        }
    } else {
        echo "Mohon masukkan NIM pengurus.";
    }
}
...
<head>
    <meta charset="UTF-8">
    <title>Hapus Data Pengurus</title>
    <style>
        body {
