...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO pameran (tanggal, nama, tempat, katalog, keterangan) VALUES ('$tanggal', '$nama', '$tempat', '$katalog', '$keterangan')";
    if (mysqli_query($conn, $sql)) {
        echo "Data pameran berhasil ditambahkan!";
    } else {
        echo "Gagal menambahkan data pameran: " . mysqli_error($conn);
        }
    }
...
<body>
	...
	<tr>
		<td>Link Katalog</td>
		<td><input type="textfield" name="katalog" maxlength="100" size="50" /></td>
	</tr>
    <tr>
		<td>Keterangan</td>
